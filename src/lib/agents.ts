...
import { applyRsyPluginSettings } from "../plugin/lib/settings.js";
...
export async function loadAgents(): Promise<Agent[]> {
  ...
  return Object.values(applyRsyPluginSettings(Object.fromEntries((config.agents || []).map((agent) => [agent.id, agent]))));
}
