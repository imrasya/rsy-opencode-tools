...
import { auditAgents } from "../plugin/lib/rsy-intelligence.js";
...
const listCommand = new Command("list")
  ...
  .action(async () => {
    ...
    if (agents.length === 0) {
      info("No agents configured. Use: rsy-opencode-tools agent create");
      process.exit(EXIT_SUCCESS);
    }
...
const auditCommand = new Command("audit")
  .description("Audit agent registry for RSY output/evidence contract quality")
